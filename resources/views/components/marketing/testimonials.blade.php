...
<section class="bg-white overflow-hidden">
    <a id="testimonials" class="absolute -mt-20"></a>
    <div class="relative max-w-screen-xl mx-auto pt-20 pb-12 px-4 sm:px-6 lg:px-8 lg:py-20">
        ...
        <div class="relative lg:flex lg:items-center">
            <div class="hidden lg:block lg:flex-shrink-0">
                <img class="h-64 w-64 rounded-full xl:h-80 xl:w-80" src="{{$testimonial->image_url}}" alt="">
            </div>

            <div class="relative lg:ml-10">
                <svg class="absolute ml-4 top-0 left-0 transform -translate-x-8 -translate-y-24 h-36 w-36 text-asg-300 opacity-50" stroke="currentColor" fill="none" viewBox="0 0 144 144">
                ...
                <blockquote class="relative">
                    <div class="prose-lg text-gray-900">
                        {!! $testimonial->text !!}
                    </div>
                    <footer class="mt-8">
                        <div class="flex">
                            <div class="flex-shrink-0 lg:hidden">
                                <img class="h-12 w-12 rounded-full" src="{{$testimonial->image_url}}" alt="">
                            </div>
                            <div class="ml-4 lg:ml-0">
                                <div class="text-base leading-6 font-medium text-gray-900">{{ $testimonial->name }}</div>
                                <div class="text-base leading-6 font-medium text-asg-500">{{ $testimonial->position }}</div>
                            </div>
                        </div>
                    </footer>
                </blockquote>
