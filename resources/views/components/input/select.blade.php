                ...
                <span class="inline-block w-full rounded-md shadow-sm">
                      ...
                      >
                            ...
                            <input
                                ...
                                type="search"
                                class="w-10 h-full form-control focus:outline-none focus:outline-white focus:ring-0 border-0 p-0"
                            />
    ...
    function select(config) {
        return {
            ...
            selectOption: function () {
                console.log("Running selectOption")
