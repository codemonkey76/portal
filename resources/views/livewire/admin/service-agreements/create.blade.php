<div class="space-y-2">
    ...
    <div class="bg-gray-300 rounded p-1">
        ...
        <x-input.group for="contract_period" label="Agreement Period">
            <div class="flex">
                <div>
                    <x-select wire:model="agreement.term">
        ...
        <x-input.group for="frequency" label="Frequency">
            <div class="flex">
                <div>
                    <x-select name="terms" wire:model="agreement.frequency">
    ...
    @if($agreement->customer)
        <div class="grid grid-cols-5 gap-2">
            ...
            <span
                class="border-b border-gray-900 col-span-4 text-gray-500">{{ $agreement->customer->company_name }}</span>
