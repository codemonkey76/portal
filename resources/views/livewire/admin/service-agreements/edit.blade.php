<div class="space-y-2">
    ...
    <!-- NetworkServiceModal -->
    <form wire:submit.prevent="saveNetworkService">
        <x-modal.dialog wire:model="showAddNetworkServiceModal">
            ...
            <x-slot name="footer">
                <div class="flex space-x-2">
                    <x-button.secondary wire:click="$set('showAddNetworkServiceModal', false)">Cancel</x-button.secondary>
                    <x-button.primary type="submit">Save</x-button.primary>
                </div>
            </x-slot>
        </x-modal.dialog>
