...
class MenuSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $admin->items()->create([
           ...
           'route' => 'service_agreements.index',
           'permission_required' => 'view service agreements',
        ...
        $admin->items()->create([
            ...
            'route' => 'service_providers.index',
            'permission_required' => 'view service providers',
        ...
        $admin->items()->create([
            ...
            'permission_required' => 'view voip servers',
